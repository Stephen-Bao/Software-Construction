...
public class StreamPractice {
     ...
     *
     *  HINT:
     *  Use flatMap, chars, and mapToObj to generate multiple elements from one element
     ...
     *  https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/stream/IntStream.html#mapToObj(java.util.function.IntFunction)
     */
    ...
    public static Stream<BigInteger> positives() {
        return Stream.iterate(BigInteger.ONE, x -> x.add(BigInteger.ONE));
    }
