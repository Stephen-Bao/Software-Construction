...
public class Logger {
	...
	private List<LoggingListener> listenerList;

	public Logger() {

		listenerList = new ArrayList<LoggingListener>();
	...
	public void addLoggingListener(LoggingListener listener) { listenerList.add(listener); }

	public void logDebug(String debugMessage) {
		for (LoggingListener ll : listenerList) {
			ll.wrireDebug(debugMessage);
		}
	}

	public void logError(String errorMassage) {
		for (LoggingListener ll : listenerList) {
			ll.writeError(errorMassage);
		}
	}
